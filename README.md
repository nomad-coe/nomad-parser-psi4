This is a NOMAD parser for [Psi4](https://psicode.org/). It will read Psi4 input and
...
```
git clone https://github.com/nomad-coe/nomad-parser-psi4.git nomad-parser-psi4
pip install -e nomad-parser-psi4
```
