...
def test_scf(parser):
    ...
    parser.parse('tests/data/adc1/output.ref', archive, None)
    ...
    assert calc.scf_iteration[10].energy.total.value.magnitude == approx(-3.31441255e-16)
...
def test_properties(parser):
    archive = EntryArchive()
    parser.parse('tests/data/scf-property/output.ref', archive, None)
    ...
    assert calc[0].charges[1].spin_projected[5].value.magnitude == approx(7.31970417e-20)
...
def test_ecp_basis(parser):
    archive = EntryArchive()
    parser.parse('tests/data/basis-ecp/output.ref', archive, None)
    ...
    assert calc[4].scf_iteration[1].energy.total.value.magnitude == approx(-3.00651252e-14)


def test_dft(parser):
    archive = EntryArchive()
    parser.parse('tests/data/dft-b3lyp/output.ref', archive, None)
    ...
    archive = EntryArchive()
    parser.parse('tests/data/dft-custom-hybrid/output.ref', archive, None)
...
def test_dft_grad(parser):
    archive = EntryArchive()
    parser.parse('tests/data/dft-grad-disk/output.ref', archive, None)
...
def test_mp2p5(parser):
    archive = EntryArchive()
    parser.parse('tests/data/mp2p5-grad1/output.ref', archive, None)
...
def test_ci(parser):
    archive = EntryArchive()
    parser.parse('tests/data/ci-property/output.ref', archive, None)
...
def test_mcscf(parser):
    archive = EntryArchive()
    parser.parse('tests/data/mcscf1/output.ref', archive, None)
...
def test_gradient(parser):
    archive = EntryArchive()
    parser.parse('tests/data/cbs-xtpl-gradient/output.ref', archive, None)
...
def test_cc(parser):
    archive = EntryArchive()
    parser.parse('tests/data/cc1/output.ref', archive, None)
    ...
    assert calc[2].scf_iteration[2].energy.total.value.magnitude == approx(-9.08810332e-19)
    assert calc[2].energy.contributions[3].value.magnitude == approx(-2.19424304e-19)
    assert calc[3].scf_iteration[9].energy.total.value.magnitude == approx(-8.98015443e-19)
